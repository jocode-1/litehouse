...
$class_id = trim(mysqli_real_escape_string($conn, !empty($data['class_id']) ? $data['class_id'] : ""));

if (empty($lecturer_id) || empty($class_id)) {
...
try {
    ...
    $response = $portal->viewButtonClass($conn, $lecturer_id, $class_id);
